...
public class KPSPublicLocator extends org.apache.axis.client.Service implements Adaptors.KPSPublic {
    ...
    public Adaptors.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public Adaptors.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Adaptors.KPSPublicSoapStub _stub = new Adaptors.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Adaptors.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                Adaptors.KPSPublicSoapStub _stub = new Adaptors.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
