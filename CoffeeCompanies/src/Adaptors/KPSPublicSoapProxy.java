...
public class KPSPublicSoapProxy implements Adaptors.KPSPublicSoap {
  private String _endpoint = null;
  private Adaptors.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new Adaptors.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public Adaptors.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
